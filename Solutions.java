public class Solutions {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(NeedleHaystack.findNeedle(haystack1));
        System.out.println(NeedleHaystack.findNeedle(haystack2));
        System.out.println(NeedleHaystack.findNeedle(haystack3));
    }
}
